          ...
          <div className="container-xl header-top">
              <div className="row align-items-center">
                  ...
                  <div className="col-md-4 col-sm-12 col-xs-12 text-center">
                      {/* site logo */}
                      <a className="navbar-brand" href="/Personal"><img style={{ width: '180px', height: '80px'}} src={logo} alt="logo" /></a>
                     {/*} <a href="/Personal" className="d-block text-logo">ATL<span className="dot">.</span></a> */}
