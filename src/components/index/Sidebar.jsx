                                  ...
                                  <div className="widget-content">
                                      ...
                                      <div className="post post-list-sm circle">
                                          <div className="thumb circle">
                                              ...
                                              <a href="/Blog-single">
                                                  <div className="inner">
                                                      <img style={{ width: '120px' , height: '60px'}} src={require('../../images/posts/tabs-1.jpg')} alt="post-title" />
                                                  </div>
                                              </a>
                                          </div>
                                      ...
                                      <div className="post post-list-sm circle">
                                          <div className="thumb circle">
                                              ...
                                              <a href="/Blog-single">
                                                  <div className="inner">
                                                      <img style={{ width: '120px' , height: '60px'}} src={require('../../images/posts/tabs-2.jpg')} alt="post-title" />
                                                  </div>
                                              </a>
                                          </div>
                                          <div className="details clearfix">
                                      ...
                                      <div className="post post-list-sm circle">
                                          <div className="thumb circle">
                                              ...
                                              <a href="/Blog-single">
                                                  <div className="inner">
                                                      <img style={{ width: '120px' , height: '60px'}} src={require('../../images/posts/tabs-3.jpg')} alt="post-title" />
                                                  </div>
                                              </a>
                                          </div>
                                          <div className="details clearfix">
