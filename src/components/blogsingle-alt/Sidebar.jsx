							...
							<div className="widget-content">
								...
								<div className="post post-list-sm circle">
									<div className="thumb circle">
										...
										<a href="/Blog-single">
											<div className="inner">
												<img src={require('../../images/posts/tabs-1.jpg')} alt="post-title" />
											</div>
										</a>
									</div>
									<div className="details clearfix">
										<h6 className="post-title my-0"><a href="/Blog-single">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam vitae odio ut tortor fringilla cursus sed quis odio</a></h6>
								...
								<div className="post post-list-sm circle">
									<div className="thumb circle">
										...
										<a href="/Blog-single">
											<div className="inner">
												<img src={require('../../images/posts/tabs-2.jpg')} alt="post-title" />
											</div>
										</a>
									</div>
									<div className="details clearfix">
								...
								<div className="post post-list-sm circle">
									<div className="thumb circle">
										...
										<a href="/Blog-single">
											<div className="inner">
												<img src={require('../../images/posts/tabs-3.jpg')} alt="post-title" />
											</div>
										</a>
									</div>
									<div className="details clearfix">
							...
							<div className="widget-content">
								<div className="post-carousel-widget">
									...
									<div className="post post-carousel">
										...
										<h5 className="post-title mb-0 mt-4"><a href="/Blog-single">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam vitae odio ut tortor fringilla cursus sed quis odio</a></h5>
