                ...
                <div className="col-md-4">
                    ...
                    <div className="contact-item bordered rounded d-flex align-items-center">
                        ...
                        <div className="details">
                            ...
                            <p className="mb-0">+1-111-555-0002</p>
                        </div>
                    </div>
                ...
                <div className="col-md-4">
                    ...
                    <div className="contact-item bordered rounded d-flex align-items-center">
                        ...
                        <div className="details">
                            ...
                            <p className="mb-0">Bangladesh, Dhaka</p>
                        </div>
                    </div>
                </div>
            ...
            <form id="contact-form" className="contact-form" method="post">
                ...
                <div className="row">
                    ...
                    <div className="column col-md-12">
                        ...
                        <div className="form-group">
                            <textarea name="InputMessage" id="InputMessage" className="form-control" rows="4" placeholder="Your message here..." required="required" data-error="Message is required."></textarea>
                            <div className="help-block with-errors"></div>
                        </div>
                    </div>
                </div>

                <button type="submit" name="submit" id="submit" value="Submit" className="btn btn-default">Submit Message</button>
